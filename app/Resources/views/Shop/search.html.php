...
<form class="row" id="js_filterfield" action="" method="get">
    ...
    <div class="col-md-9">
        <h1 class="page-title"><?= $this->translate("shop.search-result", $this->escape($this->getParam("term"))) ?></h1>
        ...
        <div class="productList" id="js-productlist">
            <?= $this->render(':Shop/list:products.html.php', array('products' => $this->products, 'language' => $this->language)) ?>
        </div>
