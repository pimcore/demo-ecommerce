...
class AccountController extends AbstractController
{
    ...
    )
    {
        ...
        if ($user && $this->isGranted('ROLE_USER')) {
            return $this->redirectToRoute('action', ['prefix' => $this->view->language, 'controller' => 'account', 'action' => 'index']);
        }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                if($session->get("referrer")) {
                    ...
                    $response = $this->redirectToRoute('action', ['prefix' => $this->view->language, 'controller' => 'account', 'action' => 'index']);
                }
