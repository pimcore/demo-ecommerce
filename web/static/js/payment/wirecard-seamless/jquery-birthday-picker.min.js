$(function (e) {
    ...
    generateBirthdayPicker = function (n, s) {
        var o = e("<fieldset class='birthdayPicker'></fieldset>"), u = e("<select required class='birthYear " + s.sizeClass + "' name='birth[year]'></select>"), a = e(" <select required class='birthMonth " + s.sizeClass + "' name='birth[month]'></select>"), f = e(" <select required class='birthDate " + s.sizeClass + "' name='birth[day]'></select>");
        $birthday = e("<input class='birthDay' name='birthDay' type='hidden'/>");
        if (s.placeholder) {
            e("<option value=''>" + ($(n).data('year-text') != 'undefined' ? $(n).data('year-text') : 'Year') + "</option>").appendTo(u);
            e("<option value=''>" + ($(n).data('month-text') ? $(n).data('month-text') : 'Month') + "</option>").appendTo(a);
            e("<option value=''>" + ($(n).data('day-text')  ? $(n).data('day-text') : 'Day') + "</option>").appendTo(f)
        }
