...
LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-assets.csv' INTO TABLE `assets`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-assets_metadata.csv' INTO TABLE `assets_metadata`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-bundle_outputdataconfigtoolkit_outputdefinition.csv' INTO TABLE `bundle_outputdataconfigtoolkit_outputdefinition`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-bundle_web2print_favorite_outputdefinitions.csv' INTO TABLE `bundle_web2print_favorite_outputdefinitions`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classes.csv' INTO TABLE `classes`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classificationstore_collectionrelations.csv' INTO TABLE `classificationstore_collectionrelations`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classificationstore_collections.csv' INTO TABLE `classificationstore_collections`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classificationstore_groups.csv' INTO TABLE `classificationstore_groups`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classificationstore_keys.csv' INTO TABLE `classificationstore_keys`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classificationstore_relations.csv' INTO TABLE `classificationstore_relations`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-classificationstore_stores.csv' INTO TABLE `classificationstore_stores`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-custom_layouts.csv' INTO TABLE `custom_layouts`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-dependencies.csv' INTO TABLE `dependencies`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents.csv' INTO TABLE `documents`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_elements.csv' INTO TABLE `documents_elements`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_email.csv' INTO TABLE `documents_email`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_hardlink.csv' INTO TABLE `documents_hardlink`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_link.csv' INTO TABLE `documents_link`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_newsletter.csv' INTO TABLE `documents_newsletter`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_page.csv' INTO TABLE `documents_page`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_printpage.csv' INTO TABLE `documents_printpage`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_snippet.csv' INTO TABLE `documents_snippet`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-documents_translations.csv' INTO TABLE `documents_translations`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_cart.csv' INTO TABLE `ecommerceframework_cart`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_cartcheckoutdata.csv' INTO TABLE `ecommerceframework_cartcheckoutdata`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_cartitem.csv' INTO TABLE `ecommerceframework_cartitem`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_optimized_productindex.csv' INTO TABLE `ecommerceframework_optimized_productindex`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_optimized_productindex_relations.csv' INTO TABLE `ecommerceframework_optimized_productindex_relations`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_pricing_rule.csv' INTO TABLE `ecommerceframework_pricing_rule`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_productindex.csv' INTO TABLE `ecommerceframework_productindex`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_productindex_relations.csv' INTO TABLE `ecommerceframework_productindex_relations`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_productindex_store.csv' INTO TABLE `ecommerceframework_productindex_store`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_vouchertoolkit_reservations.csv' INTO TABLE `ecommerceframework_vouchertoolkit_reservations`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_vouchertoolkit_statistics.csv' INTO TABLE `ecommerceframework_vouchertoolkit_statistics`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-ecommerceframework_vouchertoolkit_tokens.csv' INTO TABLE `ecommerceframework_vouchertoolkit_tokens`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-element_workflow_state.csv' INTO TABLE `element_workflow_state`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-email_blacklist.csv' INTO TABLE `email_blacklist`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-glossary.csv' INTO TABLE `glossary`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-keyvalue_groups.csv' INTO TABLE `keyvalue_groups`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-keyvalue_keys.csv' INTO TABLE `keyvalue_keys`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-keyvalue_translator_configuration.csv' INTO TABLE `keyvalue_translator_configuration`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-notes.csv' INTO TABLE `notes`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-notes_data.csv' INTO TABLE `notes_data`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderDatatrans_9.csv' INTO TABLE `object_brick_query_PaymentProviderDatatrans_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderPayPal_9.csv' INTO TABLE `object_brick_query_PaymentProviderPayPal_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderQpay_9.csv' INTO TABLE `object_brick_query_PaymentProviderQpay_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderWirecardSeamless_9.csv' INTO TABLE `object_brick_query_PaymentProviderWirecardSeamless_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_apparel_12.csv' INTO TABLE `object_brick_query_apparel_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_approvals_12.csv' INTO TABLE `object_brick_query_approvals_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsBackpacks_12.csv' INTO TABLE `object_brick_query_featuresBenefitsBackpacks_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsMats_12.csv' INTO TABLE `object_brick_query_featuresBenefitsMats_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsShoes_12.csv' INTO TABLE `object_brick_query_featuresBenefitsShoes_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsSleepingbags_12.csv' INTO TABLE `object_brick_query_featuresBenefitsSleepingbags_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsTents_12.csv' INTO TABLE `object_brick_query_featuresBenefitsTents_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresHeadlamps_12.csv' INTO TABLE `object_brick_query_featuresHeadlamps_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_matsSpecs_12.csv' INTO TABLE `object_brick_query_matsSpecs_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_outdoor_12.csv' INTO TABLE `object_brick_query_outdoor_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_rucksackSpecs_12.csv' INTO TABLE `object_brick_query_rucksackSpecs_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_shoeDetails_12.csv' INTO TABLE `object_brick_query_shoeDetails_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_shoe_12.csv' INTO TABLE `object_brick_query_shoe_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_snowsport_12.csv' INTO TABLE `object_brick_query_snowsport_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_specsSleepingbags_12.csv' INTO TABLE `object_brick_query_specsSleepingbags_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_tentGroundsheet_12.csv' INTO TABLE `object_brick_query_tentGroundsheet_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_tentSpecifications_12.csv' INTO TABLE `object_brick_query_tentSpecifications_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_query_weight_12.csv' INTO TABLE `object_brick_query_weight_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderDatatrans_9.csv' INTO TABLE `object_brick_store_PaymentProviderDatatrans_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderPayPal_9.csv' INTO TABLE `object_brick_store_PaymentProviderPayPal_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderQpay_9.csv' INTO TABLE `object_brick_store_PaymentProviderQpay_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderWirecardSeamless_9.csv' INTO TABLE `object_brick_store_PaymentProviderWirecardSeamless_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_apparel_12.csv' INTO TABLE `object_brick_store_apparel_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_approvals_12.csv' INTO TABLE `object_brick_store_approvals_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsBackpacks_12.csv' INTO TABLE `object_brick_store_featuresBenefitsBackpacks_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsMats_12.csv' INTO TABLE `object_brick_store_featuresBenefitsMats_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsShoes_12.csv' INTO TABLE `object_brick_store_featuresBenefitsShoes_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsSleepingbags_12.csv' INTO TABLE `object_brick_store_featuresBenefitsSleepingbags_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsTents_12.csv' INTO TABLE `object_brick_store_featuresBenefitsTents_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresHeadlamps_12.csv' INTO TABLE `object_brick_store_featuresHeadlamps_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_matsSpecs_12.csv' INTO TABLE `object_brick_store_matsSpecs_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_outdoor_12.csv' INTO TABLE `object_brick_store_outdoor_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_rucksackSpecs_12.csv' INTO TABLE `object_brick_store_rucksackSpecs_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_shoeDetails_12.csv' INTO TABLE `object_brick_store_shoeDetails_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_shoe_12.csv' INTO TABLE `object_brick_store_shoe_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_snowsport_12.csv' INTO TABLE `object_brick_store_snowsport_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_specsSleepingbags_12.csv' INTO TABLE `object_brick_store_specsSleepingbags_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_tentGroundsheet_12.csv' INTO TABLE `object_brick_store_tentGroundsheet_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_tentSpecifications_12.csv' INTO TABLE `object_brick_store_tentSpecifications_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_brick_store_weight_12.csv' INTO TABLE `object_brick_store_weight_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterCategory_7.csv' INTO TABLE `object_collection_FilterCategory_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterMultiRelation_7.csv' INTO TABLE `object_collection_FilterMultiRelation_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterMultiSelectFromMultiSelect_7.csv' INTO TABLE `object_collection_FilterMultiSelectFromMultiSelect_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterMultiSelect_7.csv' INTO TABLE `object_collection_FilterMultiSelect_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterNumberRangeSelection_7.csv' INTO TABLE `object_collection_FilterNumberRangeSelection_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterNumberRange_7.csv' INTO TABLE `object_collection_FilterNumberRange_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterRelation_7.csv' INTO TABLE `object_collection_FilterRelation_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterSelectFromMultiSelect_7.csv' INTO TABLE `object_collection_FilterSelectFromMultiSelect_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_FilterSelect_7.csv' INTO TABLE `object_collection_FilterSelect_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_OrderByFields_7.csv' INTO TABLE `object_collection_OrderByFields_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_OrderPriceModifications_9.csv' INTO TABLE `object_collection_OrderPriceModifications_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_PaymentInfo_9.csv' INTO TABLE `object_collection_PaymentInfo_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_PricingRule_8.csv' INTO TABLE `object_collection_PricingRule_8`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_SimilarityField_7.csv' INTO TABLE `object_collection_SimilarityField_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_TaxEntry_35.csv' INTO TABLE `object_collection_TaxEntry_35`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_TaxEntry_localized_35.csv' INTO TABLE `object_collection_TaxEntry_localized_35`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_VoucherTokenTypePattern_33.csv' INTO TABLE `object_collection_VoucherTokenTypePattern_33`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_VoucherTokenTypeSingle_33.csv' INTO TABLE `object_collection_VoucherTokenTypeSingle_33`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_collection_productImages_12.csv' INTO TABLE `object_collection_productImages_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_data_12.csv' INTO TABLE `object_localized_data_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_data_14.csv' INTO TABLE `object_localized_data_14`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_data_15.csv' INTO TABLE `object_localized_data_15`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_data_16.csv' INTO TABLE `object_localized_data_16`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_data_23.csv' INTO TABLE `object_localized_data_23`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_data_35.csv' INTO TABLE `object_localized_data_35`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_12_de_AT.csv' INTO TABLE `object_localized_query_12_de_AT`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_12_en_GB.csv' INTO TABLE `object_localized_query_12_en_GB`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_12_fr_FR.csv' INTO TABLE `object_localized_query_12_fr_FR`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_14_de_AT.csv' INTO TABLE `object_localized_query_14_de_AT`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_14_en_GB.csv' INTO TABLE `object_localized_query_14_en_GB`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_14_fr_FR.csv' INTO TABLE `object_localized_query_14_fr_FR`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_15_de_AT.csv' INTO TABLE `object_localized_query_15_de_AT`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_15_en_GB.csv' INTO TABLE `object_localized_query_15_en_GB`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_15_fr_FR.csv' INTO TABLE `object_localized_query_15_fr_FR`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_16_de_AT.csv' INTO TABLE `object_localized_query_16_de_AT`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_16_en_GB.csv' INTO TABLE `object_localized_query_16_en_GB`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_16_fr_FR.csv' INTO TABLE `object_localized_query_16_fr_FR`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_23_de_AT.csv' INTO TABLE `object_localized_query_23_de_AT`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_23_en_GB.csv' INTO TABLE `object_localized_query_23_en_GB`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_23_fr_FR.csv' INTO TABLE `object_localized_query_23_fr_FR`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_35_de_AT.csv' INTO TABLE `object_localized_query_35_de_AT`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_35_en_GB.csv' INTO TABLE `object_localized_query_35_en_GB`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_localized_query_35_fr_FR.csv' INTO TABLE `object_localized_query_35_fr_FR`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_metadata_12.csv' INTO TABLE `object_metadata_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_12.csv' INTO TABLE `object_query_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_14.csv' INTO TABLE `object_query_14`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_15.csv' INTO TABLE `object_query_15`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_16.csv' INTO TABLE `object_query_16`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_23.csv' INTO TABLE `object_query_23`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_30.csv' INTO TABLE `object_query_30`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_31.csv' INTO TABLE `object_query_31`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_32.csv' INTO TABLE `object_query_32`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_33.csv' INTO TABLE `object_query_33`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_34.csv' INTO TABLE `object_query_34`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_35.csv' INTO TABLE `object_query_35`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_7.csv' INTO TABLE `object_query_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_8.csv' INTO TABLE `object_query_8`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_query_9.csv' INTO TABLE `object_query_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_12.csv' INTO TABLE `object_relations_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_14.csv' INTO TABLE `object_relations_14`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_15.csv' INTO TABLE `object_relations_15`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_16.csv' INTO TABLE `object_relations_16`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_23.csv' INTO TABLE `object_relations_23`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_30.csv' INTO TABLE `object_relations_30`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_31.csv' INTO TABLE `object_relations_31`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_32.csv' INTO TABLE `object_relations_32`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_33.csv' INTO TABLE `object_relations_33`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_34.csv' INTO TABLE `object_relations_34`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_35.csv' INTO TABLE `object_relations_35`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_7.csv' INTO TABLE `object_relations_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_8.csv' INTO TABLE `object_relations_8`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_relations_9.csv' INTO TABLE `object_relations_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_12.csv' INTO TABLE `object_store_12`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_14.csv' INTO TABLE `object_store_14`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_15.csv' INTO TABLE `object_store_15`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_16.csv' INTO TABLE `object_store_16`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_23.csv' INTO TABLE `object_store_23`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_30.csv' INTO TABLE `object_store_30`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_31.csv' INTO TABLE `object_store_31`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_32.csv' INTO TABLE `object_store_32`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_33.csv' INTO TABLE `object_store_33`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_34.csv' INTO TABLE `object_store_34`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_35.csv' INTO TABLE `object_store_35`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_7.csv' INTO TABLE `object_store_7`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_8.csv' INTO TABLE `object_store_8`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-object_store_9.csv' INTO TABLE `object_store_9`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-objects.csv' INTO TABLE `objects`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-properties.csv' INTO TABLE `properties`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-quantityvalue_units.csv' INTO TABLE `quantityvalue_units`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-recyclebin.csv' INTO TABLE `recyclebin`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-redirects.csv' INTO TABLE `redirects`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-sanitycheck.csv' INTO TABLE `sanitycheck`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-schedule_tasks.csv' INTO TABLE `schedule_tasks`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-search_backend_data.csv' INTO TABLE `search_backend_data`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-sites.csv' INTO TABLE `sites`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-tags.csv' INTO TABLE `tags`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-tags_assignment.csv' INTO TABLE `tags_assignment`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-targeting_personas.csv' INTO TABLE `targeting_personas`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-targeting_rules.csv' INTO TABLE `targeting_rules`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-translations_admin.csv' INTO TABLE `translations_admin`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-translations_website.csv' INTO TABLE `translations_website`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-tree_locks.csv' INTO TABLE `tree_locks`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-users.csv' INTO TABLE `users`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-users_permission_definitions.csv' INTO TABLE `users_permission_definitions`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-users_workspaces_asset.csv' INTO TABLE `users_workspaces_asset`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-users_workspaces_document.csv' INTO TABLE `users_workspaces_document`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-users_workspaces_object.csv' INTO TABLE `users_workspaces_object`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-uuids.csv' INTO TABLE `uuids`;LOAD DATA INFILE '~~DOCUMENTROOT~~/install-profiles/demo-ecommerce/dump/data/dumpexport-website_settings.csv' INTO TABLE `website_settings`;
