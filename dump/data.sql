...
CREATE FUNCTION `PLUGIN_CMF_COLLECT_ASSET_SEGMENT_ASSIGNMENTS`(elementIdent INT) RETURNS text CHARSET utf8mb4
BEGIN
...
CREATE FUNCTION `PLUGIN_CMF_COLLECT_OBJECT_SEGMENT_ASSIGNMENTS`(elementIdent INT) RETURNS text CHARSET utf8mb4
BEGIN
    DECLARE segmentIds TEXT;
