...
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-assets.csv' INTO TABLE `assets`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-assets_metadata.csv' INTO TABLE `assets_metadata`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-bundle_advancedobjectsearch_savedsearch.csv' INTO TABLE `bundle_advancedobjectsearch_savedsearch`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-bundle_advancedobjectsearch_update_queue.csv' INTO TABLE `bundle_advancedobjectsearch_update_queue`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-bundle_outputdataconfigtoolkit_outputdefinition.csv' INTO TABLE `bundle_outputdataconfigtoolkit_outputdefinition`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-bundle_web2print_favorite_outputdefinitions.csv' INTO TABLE `bundle_web2print_favorite_outputdefinitions`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classes.csv' INTO TABLE `classes`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classificationstore_collectionrelations.csv' INTO TABLE `classificationstore_collectionrelations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classificationstore_collections.csv' INTO TABLE `classificationstore_collections`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classificationstore_groups.csv' INTO TABLE `classificationstore_groups`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classificationstore_keys.csv' INTO TABLE `classificationstore_keys`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classificationstore_relations.csv' INTO TABLE `classificationstore_relations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-classificationstore_stores.csv' INTO TABLE `classificationstore_stores`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-custom_layouts.csv' INTO TABLE `custom_layouts`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-dependencies.csv' INTO TABLE `dependencies`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents.csv' INTO TABLE `documents`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_elements.csv' INTO TABLE `documents_elements`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_email.csv' INTO TABLE `documents_email`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_hardlink.csv' INTO TABLE `documents_hardlink`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_link.csv' INTO TABLE `documents_link`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_newsletter.csv' INTO TABLE `documents_newsletter`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_page.csv' INTO TABLE `documents_page`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_printpage.csv' INTO TABLE `documents_printpage`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_snippet.csv' INTO TABLE `documents_snippet`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-documents_translations.csv' INTO TABLE `documents_translations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_cart.csv' INTO TABLE `ecommerceframework_cart`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_cartcheckoutdata.csv' INTO TABLE `ecommerceframework_cartcheckoutdata`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_cartitem.csv' INTO TABLE `ecommerceframework_cartitem`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_optimized_productindex.csv' INTO TABLE `ecommerceframework_optimized_productindex`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_optimized_productindex_relations.csv' INTO TABLE `ecommerceframework_optimized_productindex_relations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_pricing_rule.csv' INTO TABLE `ecommerceframework_pricing_rule`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_productindex.csv' INTO TABLE `ecommerceframework_productindex`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_productindex_relations.csv' INTO TABLE `ecommerceframework_productindex_relations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_productindex_store.csv' INTO TABLE `ecommerceframework_productindex_store`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_vouchertoolkit_reservations.csv' INTO TABLE `ecommerceframework_vouchertoolkit_reservations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_vouchertoolkit_statistics.csv' INTO TABLE `ecommerceframework_vouchertoolkit_statistics`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-ecommerceframework_vouchertoolkit_tokens.csv' INTO TABLE `ecommerceframework_vouchertoolkit_tokens`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-element_workflow_state.csv' INTO TABLE `element_workflow_state`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-email_blacklist.csv' INTO TABLE `email_blacklist`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-glossary.csv' INTO TABLE `glossary`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-gridconfig_favourites.csv' INTO TABLE `gridconfig_favourites`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-gridconfig_shares.csv' INTO TABLE `gridconfig_shares`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-gridconfigs.csv' INTO TABLE `gridconfigs`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-importconfig_shares.csv' INTO TABLE `importconfig_shares`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-importconfigs.csv' INTO TABLE `importconfigs`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-notes.csv' INTO TABLE `notes`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-notes_data.csv' INTO TABLE `notes_data`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_OAuth1Token_38.csv' INTO TABLE `object_brick_query_OAuth1Token_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_OAuth2Token_38.csv' INTO TABLE `object_brick_query_OAuth2Token_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderDatatrans_9.csv' INTO TABLE `object_brick_query_PaymentProviderDatatrans_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderPayPal_9.csv' INTO TABLE `object_brick_query_PaymentProviderPayPal_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderQpay_9.csv' INTO TABLE `object_brick_query_PaymentProviderQpay_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_PaymentProviderWirecardSeamless_9.csv' INTO TABLE `object_brick_query_PaymentProviderWirecardSeamless_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_apparel_12.csv' INTO TABLE `object_brick_query_apparel_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_approvals_12.csv' INTO TABLE `object_brick_query_approvals_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsBackpacks_12.csv' INTO TABLE `object_brick_query_featuresBenefitsBackpacks_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsMats_12.csv' INTO TABLE `object_brick_query_featuresBenefitsMats_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsShoes_12.csv' INTO TABLE `object_brick_query_featuresBenefitsShoes_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsSleepingbags_12.csv' INTO TABLE `object_brick_query_featuresBenefitsSleepingbags_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresBenefitsTents_12.csv' INTO TABLE `object_brick_query_featuresBenefitsTents_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_featuresHeadlamps_12.csv' INTO TABLE `object_brick_query_featuresHeadlamps_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_matsSpecs_12.csv' INTO TABLE `object_brick_query_matsSpecs_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_outdoor_12.csv' INTO TABLE `object_brick_query_outdoor_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_rucksackSpecs_12.csv' INTO TABLE `object_brick_query_rucksackSpecs_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_shoeDetails_12.csv' INTO TABLE `object_brick_query_shoeDetails_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_shoe_12.csv' INTO TABLE `object_brick_query_shoe_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_snowsport_12.csv' INTO TABLE `object_brick_query_snowsport_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_specsSleepingbags_12.csv' INTO TABLE `object_brick_query_specsSleepingbags_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_tentGroundsheet_12.csv' INTO TABLE `object_brick_query_tentGroundsheet_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_tentSpecifications_12.csv' INTO TABLE `object_brick_query_tentSpecifications_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_query_weight_12.csv' INTO TABLE `object_brick_query_weight_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_OAuth1Token_38.csv' INTO TABLE `object_brick_store_OAuth1Token_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_OAuth2Token_38.csv' INTO TABLE `object_brick_store_OAuth2Token_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderDatatrans_9.csv' INTO TABLE `object_brick_store_PaymentProviderDatatrans_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderPayPal_9.csv' INTO TABLE `object_brick_store_PaymentProviderPayPal_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderQpay_9.csv' INTO TABLE `object_brick_store_PaymentProviderQpay_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_PaymentProviderWirecardSeamless_9.csv' INTO TABLE `object_brick_store_PaymentProviderWirecardSeamless_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_apparel_12.csv' INTO TABLE `object_brick_store_apparel_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_approvals_12.csv' INTO TABLE `object_brick_store_approvals_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsBackpacks_12.csv' INTO TABLE `object_brick_store_featuresBenefitsBackpacks_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsMats_12.csv' INTO TABLE `object_brick_store_featuresBenefitsMats_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsShoes_12.csv' INTO TABLE `object_brick_store_featuresBenefitsShoes_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsSleepingbags_12.csv' INTO TABLE `object_brick_store_featuresBenefitsSleepingbags_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresBenefitsTents_12.csv' INTO TABLE `object_brick_store_featuresBenefitsTents_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_featuresHeadlamps_12.csv' INTO TABLE `object_brick_store_featuresHeadlamps_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_matsSpecs_12.csv' INTO TABLE `object_brick_store_matsSpecs_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_outdoor_12.csv' INTO TABLE `object_brick_store_outdoor_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_rucksackSpecs_12.csv' INTO TABLE `object_brick_store_rucksackSpecs_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_shoeDetails_12.csv' INTO TABLE `object_brick_store_shoeDetails_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_shoe_12.csv' INTO TABLE `object_brick_store_shoe_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_snowsport_12.csv' INTO TABLE `object_brick_store_snowsport_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_specsSleepingbags_12.csv' INTO TABLE `object_brick_store_specsSleepingbags_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_tentGroundsheet_12.csv' INTO TABLE `object_brick_store_tentGroundsheet_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_tentSpecifications_12.csv' INTO TABLE `object_brick_store_tentSpecifications_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_brick_store_weight_12.csv' INTO TABLE `object_brick_store_weight_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterCategory_7.csv' INTO TABLE `object_collection_FilterCategory_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterMultiRelation_7.csv' INTO TABLE `object_collection_FilterMultiRelation_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterMultiSelectFromMultiSelect_7.csv' INTO TABLE `object_collection_FilterMultiSelectFromMultiSelect_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterMultiSelect_7.csv' INTO TABLE `object_collection_FilterMultiSelect_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterNumberRangeSelection_7.csv' INTO TABLE `object_collection_FilterNumberRangeSelection_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterNumberRange_7.csv' INTO TABLE `object_collection_FilterNumberRange_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterRelation_7.csv' INTO TABLE `object_collection_FilterRelation_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterSelectFromMultiSelect_7.csv' INTO TABLE `object_collection_FilterSelectFromMultiSelect_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_FilterSelect_7.csv' INTO TABLE `object_collection_FilterSelect_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_OrderByFields_7.csv' INTO TABLE `object_collection_OrderByFields_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_OrderPriceModifications_9.csv' INTO TABLE `object_collection_OrderPriceModifications_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_PaymentInfo_9.csv' INTO TABLE `object_collection_PaymentInfo_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_PricingRule_8.csv' INTO TABLE `object_collection_PricingRule_8`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_SimilarityField_7.csv' INTO TABLE `object_collection_SimilarityField_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_TaxEntry_35.csv' INTO TABLE `object_collection_TaxEntry_35`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_TaxEntry_localized_35.csv' INTO TABLE `object_collection_TaxEntry_localized_35`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_VoucherTokenTypePattern_33.csv' INTO TABLE `object_collection_VoucherTokenTypePattern_33`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_VoucherTokenTypeSingle_33.csv' INTO TABLE `object_collection_VoucherTokenTypeSingle_33`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_collection_productImages_12.csv' INTO TABLE `object_collection_productImages_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_data_12.csv' INTO TABLE `object_localized_data_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_data_14.csv' INTO TABLE `object_localized_data_14`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_data_15.csv' INTO TABLE `object_localized_data_15`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_data_16.csv' INTO TABLE `object_localized_data_16`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_data_23.csv' INTO TABLE `object_localized_data_23`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_data_35.csv' INTO TABLE `object_localized_data_35`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_12_de_AT.csv' INTO TABLE `object_localized_query_12_de_AT`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_12_en_GB.csv' INTO TABLE `object_localized_query_12_en_GB`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_12_fr_FR.csv' INTO TABLE `object_localized_query_12_fr_FR`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_14_de_AT.csv' INTO TABLE `object_localized_query_14_de_AT`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_14_en_GB.csv' INTO TABLE `object_localized_query_14_en_GB`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_14_fr_FR.csv' INTO TABLE `object_localized_query_14_fr_FR`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_15_de_AT.csv' INTO TABLE `object_localized_query_15_de_AT`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_15_en_GB.csv' INTO TABLE `object_localized_query_15_en_GB`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_15_fr_FR.csv' INTO TABLE `object_localized_query_15_fr_FR`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_16_de_AT.csv' INTO TABLE `object_localized_query_16_de_AT`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_16_en_GB.csv' INTO TABLE `object_localized_query_16_en_GB`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_16_fr_FR.csv' INTO TABLE `object_localized_query_16_fr_FR`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_23_de_AT.csv' INTO TABLE `object_localized_query_23_de_AT`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_23_en_GB.csv' INTO TABLE `object_localized_query_23_en_GB`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_23_fr_FR.csv' INTO TABLE `object_localized_query_23_fr_FR`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_35_de_AT.csv' INTO TABLE `object_localized_query_35_de_AT`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_35_en_GB.csv' INTO TABLE `object_localized_query_35_en_GB`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_localized_query_35_fr_FR.csv' INTO TABLE `object_localized_query_35_fr_FR`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_metadata_12.csv' INTO TABLE `object_metadata_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_metadata_41.csv' INTO TABLE `object_metadata_41`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_12.csv' INTO TABLE `object_query_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_14.csv' INTO TABLE `object_query_14`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_15.csv' INTO TABLE `object_query_15`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_16.csv' INTO TABLE `object_query_16`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_23.csv' INTO TABLE `object_query_23`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_30.csv' INTO TABLE `object_query_30`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_31.csv' INTO TABLE `object_query_31`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_32.csv' INTO TABLE `object_query_32`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_33.csv' INTO TABLE `object_query_33`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_34.csv' INTO TABLE `object_query_34`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_35.csv' INTO TABLE `object_query_35`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_36.csv' INTO TABLE `object_query_36`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_37.csv' INTO TABLE `object_query_37`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_38.csv' INTO TABLE `object_query_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_39.csv' INTO TABLE `object_query_39`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_40.csv' INTO TABLE `object_query_40`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_41.csv' INTO TABLE `object_query_41`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_7.csv' INTO TABLE `object_query_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_8.csv' INTO TABLE `object_query_8`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_query_9.csv' INTO TABLE `object_query_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_12.csv' INTO TABLE `object_relations_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_14.csv' INTO TABLE `object_relations_14`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_15.csv' INTO TABLE `object_relations_15`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_16.csv' INTO TABLE `object_relations_16`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_23.csv' INTO TABLE `object_relations_23`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_30.csv' INTO TABLE `object_relations_30`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_31.csv' INTO TABLE `object_relations_31`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_32.csv' INTO TABLE `object_relations_32`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_33.csv' INTO TABLE `object_relations_33`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_34.csv' INTO TABLE `object_relations_34`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_35.csv' INTO TABLE `object_relations_35`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_36.csv' INTO TABLE `object_relations_36`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_37.csv' INTO TABLE `object_relations_37`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_38.csv' INTO TABLE `object_relations_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_39.csv' INTO TABLE `object_relations_39`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_40.csv' INTO TABLE `object_relations_40`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_41.csv' INTO TABLE `object_relations_41`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_7.csv' INTO TABLE `object_relations_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_8.csv' INTO TABLE `object_relations_8`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_relations_9.csv' INTO TABLE `object_relations_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_12.csv' INTO TABLE `object_store_12`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_14.csv' INTO TABLE `object_store_14`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_15.csv' INTO TABLE `object_store_15`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_16.csv' INTO TABLE `object_store_16`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_23.csv' INTO TABLE `object_store_23`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_30.csv' INTO TABLE `object_store_30`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_31.csv' INTO TABLE `object_store_31`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_32.csv' INTO TABLE `object_store_32`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_33.csv' INTO TABLE `object_store_33`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_34.csv' INTO TABLE `object_store_34`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_35.csv' INTO TABLE `object_store_35`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_36.csv' INTO TABLE `object_store_36`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_37.csv' INTO TABLE `object_store_37`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_38.csv' INTO TABLE `object_store_38`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_39.csv' INTO TABLE `object_store_39`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_40.csv' INTO TABLE `object_store_40`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_41.csv' INTO TABLE `object_store_41`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_7.csv' INTO TABLE `object_store_7`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_8.csv' INTO TABLE `object_store_8`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-object_store_9.csv' INTO TABLE `object_store_9`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-objects.csv' INTO TABLE `objects`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-pimcore_migrations.csv' INTO TABLE `pimcore_migrations`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_actiontrigger_actions.csv' INTO TABLE `plugin_cmf_actiontrigger_actions`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_actiontrigger_queue.csv' INTO TABLE `plugin_cmf_actiontrigger_queue`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_actiontrigger_rules.csv' INTO TABLE `plugin_cmf_actiontrigger_rules`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_activities.csv' INTO TABLE `plugin_cmf_activities`(id, customerId, activityDate, type, implementationClass, o_id, a_id, @hexAttributes, md5, creationDate, modificationDate) SET attributes=UNHEX(@hexAttributes);
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_customer_filter_definition.csv' INTO TABLE `plugin_cmf_customer_filter_definition`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_deletions.csv' INTO TABLE `plugin_cmf_deletions`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_duplicates_false_positives.csv' INTO TABLE `plugin_cmf_duplicates_false_positives`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_duplicatesindex.csv' INTO TABLE `plugin_cmf_duplicatesindex`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_duplicatesindex_customers.csv' INTO TABLE `plugin_cmf_duplicatesindex_customers`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_newsletter_queue.csv' INTO TABLE `plugin_cmf_newsletter_queue`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_potential_duplicates.csv' INTO TABLE `plugin_cmf_potential_duplicates`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_segment_assignment.csv' INTO TABLE `plugin_cmf_segment_assignment`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_segment_assignment_index.csv' INTO TABLE `plugin_cmf_segment_assignment_index`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_segment_assignment_queue.csv' INTO TABLE `plugin_cmf_segment_assignment_queue`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_segmentbuilder_changes_queue.csv' INTO TABLE `plugin_cmf_segmentbuilder_changes_queue`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-plugin_cmf_sequence_numbers.csv' INTO TABLE `plugin_cmf_sequence_numbers`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-properties.csv' INTO TABLE `properties`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-quantityvalue_units.csv' INTO TABLE `quantityvalue_units`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-recyclebin.csv' INTO TABLE `recyclebin`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-redirects.csv' INTO TABLE `redirects`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-sanitycheck.csv' INTO TABLE `sanitycheck`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-schedule_tasks.csv' INTO TABLE `schedule_tasks`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-search_backend_data.csv' INTO TABLE `search_backend_data`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-sites.csv' INTO TABLE `sites`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-tags.csv' INTO TABLE `tags`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-tags_assignment.csv' INTO TABLE `tags_assignment`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-targeting_rules.csv' INTO TABLE `targeting_rules`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-targeting_target_groups.csv' INTO TABLE `targeting_target_groups`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-translations_admin.csv' INTO TABLE `translations_admin`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-translations_website.csv' INTO TABLE `translations_website`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-tree_locks.csv' INTO TABLE `tree_locks`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-users.csv' INTO TABLE `users`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-users_permission_definitions.csv' INTO TABLE `users_permission_definitions`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-users_workspaces_asset.csv' INTO TABLE `users_workspaces_asset`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-users_workspaces_document.csv' INTO TABLE `users_workspaces_document`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-users_workspaces_object.csv' INTO TABLE `users_workspaces_object`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-uuids.csv' INTO TABLE `uuids`;
LOAD DATA LOCAL INFILE '~~DOCUMENTROOT~~/vendor/pimcore/demo-ecommerce/dump/data/dumpexport-website_settings.csv' INTO TABLE `website_settings`;


DROP VIEW IF EXISTS object_12;
CREATE ALGORITHM=UNDEFINED  VIEW `object_12` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className` from (`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`)));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_12_de_AT` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`de_AT`.`ooo_id` AS `ooo_id`,`de_AT`.`language` AS `language`,`de_AT`.`name` AS `name`,`de_AT`.`seoname` AS `seoname`,`de_AT`.`colorName` AS `colorName`,`de_AT`.`price` AS `price`,`de_AT`.`priceOld` AS `priceOld`,`de_AT`.`fromPrice` AS `fromPrice`,`de_AT`.`description` AS `description`,`de_AT`.`material` AS `material`,`de_AT`.`downloads` AS `downloads`,`de_AT`.`videos` AS `videos`,`de_AT`.`rotation__id` AS `rotation__id`,`de_AT`.`rotation__type` AS `rotation__type`,`de_AT`.`youtubeVideo` AS `youtubeVideo`,`de_AT`.`textsAvailable` AS `textsAvailable` from ((`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`))) left join `object_localized_query_12_de_AT` `de_AT` on((1 and (`object_query_12`.`oo_id` = `de_AT`.`ooo_id`))));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_12_en_GB` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`en_GB`.`ooo_id` AS `ooo_id`,`en_GB`.`language` AS `language`,`en_GB`.`name` AS `name`,`en_GB`.`seoname` AS `seoname`,`en_GB`.`colorName` AS `colorName`,`en_GB`.`price` AS `price`,`en_GB`.`priceOld` AS `priceOld`,`en_GB`.`fromPrice` AS `fromPrice`,`en_GB`.`description` AS `description`,`en_GB`.`material` AS `material`,`en_GB`.`downloads` AS `downloads`,`en_GB`.`videos` AS `videos`,`en_GB`.`rotation__id` AS `rotation__id`,`en_GB`.`rotation__type` AS `rotation__type`,`en_GB`.`youtubeVideo` AS `youtubeVideo`,`en_GB`.`textsAvailable` AS `textsAvailable` from ((`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`))) left join `object_localized_query_12_en_GB` `en_GB` on((1 and (`object_query_12`.`oo_id` = `en_GB`.`ooo_id`))));

DROP VIEW IF EXISTS object_localized_12_fr_FR;
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_12_fr_FR` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`fr_FR`.`ooo_id` AS `ooo_id`,`fr_FR`.`language` AS `language`,`fr_FR`.`name` AS `name`,`fr_FR`.`seoname` AS `seoname`,`fr_FR`.`colorName` AS `colorName`,`fr_FR`.`price` AS `price`,`fr_FR`.`priceOld` AS `priceOld`,`fr_FR`.`fromPrice` AS `fromPrice`,`fr_FR`.`description` AS `description`,`fr_FR`.`material` AS `material`,`fr_FR`.`downloads` AS `downloads`,`fr_FR`.`videos` AS `videos`,`fr_FR`.`rotation__id` AS `rotation__id`,`fr_FR`.`rotation__type` AS `rotation__type`,`fr_FR`.`youtubeVideo` AS `youtubeVideo`,`fr_FR`.`textsAvailable` AS `textsAvailable` from ((`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`))) left join `object_localized_query_12_fr_FR` `fr_FR` on((1 and (`object_query_12`.`oo_id` = `fr_FR`.`ooo_id`))));
