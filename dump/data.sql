...
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-assets.csv' INTO TABLE `assets`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-assets_metadata.csv' INTO TABLE `assets_metadata`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-bundle_advancedobjectsearch_savedsearch.csv' INTO TABLE `bundle_advancedobjectsearch_savedsearch`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-bundle_advancedobjectsearch_update_queue.csv' INTO TABLE `bundle_advancedobjectsearch_update_queue`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-bundle_outputdataconfigtoolkit_outputdefinition.csv' INTO TABLE `bundle_outputdataconfigtoolkit_outputdefinition`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-bundle_web2print_favorite_outputdefinitions.csv' INTO TABLE `bundle_web2print_favorite_outputdefinitions`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classes.csv' INTO TABLE `classes`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classificationstore_collectionrelations.csv' INTO TABLE `classificationstore_collectionrelations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classificationstore_collections.csv' INTO TABLE `classificationstore_collections`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classificationstore_groups.csv' INTO TABLE `classificationstore_groups`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classificationstore_keys.csv' INTO TABLE `classificationstore_keys`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classificationstore_relations.csv' INTO TABLE `classificationstore_relations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-classificationstore_stores.csv' INTO TABLE `classificationstore_stores`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-custom_layouts.csv' INTO TABLE `custom_layouts`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-dependencies.csv' INTO TABLE `dependencies`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents.csv' INTO TABLE `documents`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_elements.csv' INTO TABLE `documents_elements`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_email.csv' INTO TABLE `documents_email`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_hardlink.csv' INTO TABLE `documents_hardlink`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_link.csv' INTO TABLE `documents_link`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_newsletter.csv' INTO TABLE `documents_newsletter`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_page.csv' INTO TABLE `documents_page`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_printpage.csv' INTO TABLE `documents_printpage`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_snippet.csv' INTO TABLE `documents_snippet`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-documents_translations.csv' INTO TABLE `documents_translations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_cart.csv' INTO TABLE `ecommerceframework_cart`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_cartcheckoutdata.csv' INTO TABLE `ecommerceframework_cartcheckoutdata`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_cartitem.csv' INTO TABLE `ecommerceframework_cartitem`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_optimized_productindex.csv' INTO TABLE `ecommerceframework_optimized_productindex`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_optimized_productindex_relations.csv' INTO TABLE `ecommerceframework_optimized_productindex_relations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_pricing_rule.csv' INTO TABLE `ecommerceframework_pricing_rule`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_productindex.csv' INTO TABLE `ecommerceframework_productindex`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_productindex_relations.csv' INTO TABLE `ecommerceframework_productindex_relations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_productindex_store.csv' INTO TABLE `ecommerceframework_productindex_store`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_vouchertoolkit_reservations.csv' INTO TABLE `ecommerceframework_vouchertoolkit_reservations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_vouchertoolkit_statistics.csv' INTO TABLE `ecommerceframework_vouchertoolkit_statistics`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-ecommerceframework_vouchertoolkit_tokens.csv' INTO TABLE `ecommerceframework_vouchertoolkit_tokens`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-element_workflow_state.csv' INTO TABLE `element_workflow_state`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-email_blacklist.csv' INTO TABLE `email_blacklist`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-glossary.csv' INTO TABLE `glossary`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-gridconfig_favourites.csv' INTO TABLE `gridconfig_favourites`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-gridconfig_shares.csv' INTO TABLE `gridconfig_shares`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-gridconfigs.csv' INTO TABLE `gridconfigs`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-importconfig_shares.csv' INTO TABLE `importconfig_shares`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-importconfigs.csv' INTO TABLE `importconfigs`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-notes.csv' INTO TABLE `notes`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-notes_data.csv' INTO TABLE `notes_data`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_OAuth1Token_38.csv' INTO TABLE `object_brick_query_OAuth1Token_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_OAuth2Token_38.csv' INTO TABLE `object_brick_query_OAuth2Token_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_PaymentProviderDatatrans_9.csv' INTO TABLE `object_brick_query_PaymentProviderDatatrans_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_PaymentProviderMpay24_9.csv' INTO TABLE `object_brick_query_PaymentProviderMpay24_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_PaymentProviderOGone_9.csv' INTO TABLE `object_brick_query_PaymentProviderOGone_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_PaymentProviderPayPal_9.csv' INTO TABLE `object_brick_query_PaymentProviderPayPal_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_PaymentProviderQpay_9.csv' INTO TABLE `object_brick_query_PaymentProviderQpay_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_PaymentProviderWirecardSeamless_9.csv' INTO TABLE `object_brick_query_PaymentProviderWirecardSeamless_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_apparel_12.csv' INTO TABLE `object_brick_query_apparel_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_approvals_12.csv' INTO TABLE `object_brick_query_approvals_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_featuresBenefitsBackpacks_12.csv' INTO TABLE `object_brick_query_featuresBenefitsBackpacks_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_featuresBenefitsMats_12.csv' INTO TABLE `object_brick_query_featuresBenefitsMats_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_featuresBenefitsShoes_12.csv' INTO TABLE `object_brick_query_featuresBenefitsShoes_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_featuresBenefitsSleepingbags_12.csv' INTO TABLE `object_brick_query_featuresBenefitsSleepingbags_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_featuresBenefitsTents_12.csv' INTO TABLE `object_brick_query_featuresBenefitsTents_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_featuresHeadlamps_12.csv' INTO TABLE `object_brick_query_featuresHeadlamps_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_matsSpecs_12.csv' INTO TABLE `object_brick_query_matsSpecs_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_outdoor_12.csv' INTO TABLE `object_brick_query_outdoor_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_rucksackSpecs_12.csv' INTO TABLE `object_brick_query_rucksackSpecs_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_shoeDetails_12.csv' INTO TABLE `object_brick_query_shoeDetails_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_shoe_12.csv' INTO TABLE `object_brick_query_shoe_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_snowsport_12.csv' INTO TABLE `object_brick_query_snowsport_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_specsSleepingbags_12.csv' INTO TABLE `object_brick_query_specsSleepingbags_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_tentGroundsheet_12.csv' INTO TABLE `object_brick_query_tentGroundsheet_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_tentSpecifications_12.csv' INTO TABLE `object_brick_query_tentSpecifications_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_query_weight_12.csv' INTO TABLE `object_brick_query_weight_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_OAuth1Token_38.csv' INTO TABLE `object_brick_store_OAuth1Token_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_OAuth2Token_38.csv' INTO TABLE `object_brick_store_OAuth2Token_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_PaymentProviderDatatrans_9.csv' INTO TABLE `object_brick_store_PaymentProviderDatatrans_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_PaymentProviderMpay24_9.csv' INTO TABLE `object_brick_store_PaymentProviderMpay24_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_PaymentProviderOGone_9.csv' INTO TABLE `object_brick_store_PaymentProviderOGone_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_PaymentProviderPayPal_9.csv' INTO TABLE `object_brick_store_PaymentProviderPayPal_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_PaymentProviderQpay_9.csv' INTO TABLE `object_brick_store_PaymentProviderQpay_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_PaymentProviderWirecardSeamless_9.csv' INTO TABLE `object_brick_store_PaymentProviderWirecardSeamless_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_apparel_12.csv' INTO TABLE `object_brick_store_apparel_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_approvals_12.csv' INTO TABLE `object_brick_store_approvals_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_featuresBenefitsBackpacks_12.csv' INTO TABLE `object_brick_store_featuresBenefitsBackpacks_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_featuresBenefitsMats_12.csv' INTO TABLE `object_brick_store_featuresBenefitsMats_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_featuresBenefitsShoes_12.csv' INTO TABLE `object_brick_store_featuresBenefitsShoes_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_featuresBenefitsSleepingbags_12.csv' INTO TABLE `object_brick_store_featuresBenefitsSleepingbags_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_featuresBenefitsTents_12.csv' INTO TABLE `object_brick_store_featuresBenefitsTents_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_featuresHeadlamps_12.csv' INTO TABLE `object_brick_store_featuresHeadlamps_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_matsSpecs_12.csv' INTO TABLE `object_brick_store_matsSpecs_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_outdoor_12.csv' INTO TABLE `object_brick_store_outdoor_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_rucksackSpecs_12.csv' INTO TABLE `object_brick_store_rucksackSpecs_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_shoeDetails_12.csv' INTO TABLE `object_brick_store_shoeDetails_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_shoe_12.csv' INTO TABLE `object_brick_store_shoe_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_snowsport_12.csv' INTO TABLE `object_brick_store_snowsport_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_specsSleepingbags_12.csv' INTO TABLE `object_brick_store_specsSleepingbags_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_tentGroundsheet_12.csv' INTO TABLE `object_brick_store_tentGroundsheet_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_tentSpecifications_12.csv' INTO TABLE `object_brick_store_tentSpecifications_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_brick_store_weight_12.csv' INTO TABLE `object_brick_store_weight_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterCategory_7.csv' INTO TABLE `object_collection_FilterCategory_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterMultiRelation_7.csv' INTO TABLE `object_collection_FilterMultiRelation_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterMultiSelectFromMultiSelect_7.csv' INTO TABLE `object_collection_FilterMultiSelectFromMultiSelect_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterMultiSelect_7.csv' INTO TABLE `object_collection_FilterMultiSelect_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterNumberRangeSelection_7.csv' INTO TABLE `object_collection_FilterNumberRangeSelection_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterNumberRange_7.csv' INTO TABLE `object_collection_FilterNumberRange_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterRelation_7.csv' INTO TABLE `object_collection_FilterRelation_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterSelectFromMultiSelect_7.csv' INTO TABLE `object_collection_FilterSelectFromMultiSelect_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_FilterSelect_7.csv' INTO TABLE `object_collection_FilterSelect_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_OrderByFields_7.csv' INTO TABLE `object_collection_OrderByFields_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_OrderPriceModifications_9.csv' INTO TABLE `object_collection_OrderPriceModifications_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_PaymentInfo_9.csv' INTO TABLE `object_collection_PaymentInfo_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_PricingRule_8.csv' INTO TABLE `object_collection_PricingRule_8`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_SimilarityField_7.csv' INTO TABLE `object_collection_SimilarityField_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_TaxEntry_35.csv' INTO TABLE `object_collection_TaxEntry_35`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_TaxEntry_localized_35.csv' INTO TABLE `object_collection_TaxEntry_localized_35`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_VoucherTokenTypePattern_33.csv' INTO TABLE `object_collection_VoucherTokenTypePattern_33`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_VoucherTokenTypeSingle_33.csv' INTO TABLE `object_collection_VoucherTokenTypeSingle_33`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_collection_productImages_12.csv' INTO TABLE `object_collection_productImages_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_data_12.csv' INTO TABLE `object_localized_data_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_data_14.csv' INTO TABLE `object_localized_data_14`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_data_15.csv' INTO TABLE `object_localized_data_15`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_data_16.csv' INTO TABLE `object_localized_data_16`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_data_23.csv' INTO TABLE `object_localized_data_23`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_data_35.csv' INTO TABLE `object_localized_data_35`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_12_de_AT.csv' INTO TABLE `object_localized_query_12_de_AT`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_12_en_GB.csv' INTO TABLE `object_localized_query_12_en_GB`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_12_fr_FR.csv' INTO TABLE `object_localized_query_12_fr_FR`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_14_de_AT.csv' INTO TABLE `object_localized_query_14_de_AT`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_14_en_GB.csv' INTO TABLE `object_localized_query_14_en_GB`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_14_fr_FR.csv' INTO TABLE `object_localized_query_14_fr_FR`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_15_de_AT.csv' INTO TABLE `object_localized_query_15_de_AT`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_15_en_GB.csv' INTO TABLE `object_localized_query_15_en_GB`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_15_fr_FR.csv' INTO TABLE `object_localized_query_15_fr_FR`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_16_de_AT.csv' INTO TABLE `object_localized_query_16_de_AT`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_16_en_GB.csv' INTO TABLE `object_localized_query_16_en_GB`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_16_fr_FR.csv' INTO TABLE `object_localized_query_16_fr_FR`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_23_de_AT.csv' INTO TABLE `object_localized_query_23_de_AT`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_23_en_GB.csv' INTO TABLE `object_localized_query_23_en_GB`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_23_fr_FR.csv' INTO TABLE `object_localized_query_23_fr_FR`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_35_de_AT.csv' INTO TABLE `object_localized_query_35_de_AT`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_35_en_GB.csv' INTO TABLE `object_localized_query_35_en_GB`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_localized_query_35_fr_FR.csv' INTO TABLE `object_localized_query_35_fr_FR`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_metadata_12.csv' INTO TABLE `object_metadata_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_metadata_41.csv' INTO TABLE `object_metadata_41`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_12.csv' INTO TABLE `object_query_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_14.csv' INTO TABLE `object_query_14`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_15.csv' INTO TABLE `object_query_15`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_16.csv' INTO TABLE `object_query_16`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_23.csv' INTO TABLE `object_query_23`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_30.csv' INTO TABLE `object_query_30`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_31.csv' INTO TABLE `object_query_31`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_32.csv' INTO TABLE `object_query_32`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_33.csv' INTO TABLE `object_query_33`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_34.csv' INTO TABLE `object_query_34`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_35.csv' INTO TABLE `object_query_35`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_36.csv' INTO TABLE `object_query_36`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_37.csv' INTO TABLE `object_query_37`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_38.csv' INTO TABLE `object_query_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_39.csv' INTO TABLE `object_query_39`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_40.csv' INTO TABLE `object_query_40`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_41.csv' INTO TABLE `object_query_41`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_7.csv' INTO TABLE `object_query_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_8.csv' INTO TABLE `object_query_8`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_query_9.csv' INTO TABLE `object_query_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_12.csv' INTO TABLE `object_relations_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_14.csv' INTO TABLE `object_relations_14`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_15.csv' INTO TABLE `object_relations_15`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_16.csv' INTO TABLE `object_relations_16`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_23.csv' INTO TABLE `object_relations_23`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_30.csv' INTO TABLE `object_relations_30`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_31.csv' INTO TABLE `object_relations_31`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_32.csv' INTO TABLE `object_relations_32`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_33.csv' INTO TABLE `object_relations_33`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_34.csv' INTO TABLE `object_relations_34`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_35.csv' INTO TABLE `object_relations_35`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_36.csv' INTO TABLE `object_relations_36`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_37.csv' INTO TABLE `object_relations_37`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_38.csv' INTO TABLE `object_relations_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_39.csv' INTO TABLE `object_relations_39`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_40.csv' INTO TABLE `object_relations_40`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_41.csv' INTO TABLE `object_relations_41`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_7.csv' INTO TABLE `object_relations_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_8.csv' INTO TABLE `object_relations_8`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_relations_9.csv' INTO TABLE `object_relations_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_12.csv' INTO TABLE `object_store_12`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_14.csv' INTO TABLE `object_store_14`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_15.csv' INTO TABLE `object_store_15`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_16.csv' INTO TABLE `object_store_16`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_23.csv' INTO TABLE `object_store_23`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_30.csv' INTO TABLE `object_store_30`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_31.csv' INTO TABLE `object_store_31`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_32.csv' INTO TABLE `object_store_32`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_33.csv' INTO TABLE `object_store_33`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_34.csv' INTO TABLE `object_store_34`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_35.csv' INTO TABLE `object_store_35`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_36.csv' INTO TABLE `object_store_36`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_37.csv' INTO TABLE `object_store_37`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_38.csv' INTO TABLE `object_store_38`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_39.csv' INTO TABLE `object_store_39`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_40.csv' INTO TABLE `object_store_40`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_41.csv' INTO TABLE `object_store_41`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_7.csv' INTO TABLE `object_store_7`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_8.csv' INTO TABLE `object_store_8`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-object_store_9.csv' INTO TABLE `object_store_9`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-objects.csv' INTO TABLE `objects`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-pimcore_migrations.csv' INTO TABLE `pimcore_migrations`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_actiontrigger_actions.csv' INTO TABLE `plugin_cmf_actiontrigger_actions`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_actiontrigger_queue.csv' INTO TABLE `plugin_cmf_actiontrigger_queue`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_actiontrigger_rules.csv' INTO TABLE `plugin_cmf_actiontrigger_rules`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_activities.csv' INTO TABLE `plugin_cmf_activities`(id, customerId, activityDate, type, implementationClass, o_id, a_id, @hexAttributes, md5, creationDate, modificationDate) SET attributes=UNHEX(@hexAttributes);
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_customer_filter_definition.csv' INTO TABLE `plugin_cmf_customer_filter_definition`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_deletions.csv' INTO TABLE `plugin_cmf_deletions`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_duplicates_false_positives.csv' INTO TABLE `plugin_cmf_duplicates_false_positives`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_duplicatesindex.csv' INTO TABLE `plugin_cmf_duplicatesindex`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_duplicatesindex_customers.csv' INTO TABLE `plugin_cmf_duplicatesindex_customers`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_newsletter_queue.csv' INTO TABLE `plugin_cmf_newsletter_queue`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_potential_duplicates.csv' INTO TABLE `plugin_cmf_potential_duplicates`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_segment_assignment.csv' INTO TABLE `plugin_cmf_segment_assignment`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_segment_assignment_index.csv' INTO TABLE `plugin_cmf_segment_assignment_index`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_segment_assignment_queue.csv' INTO TABLE `plugin_cmf_segment_assignment_queue`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_segmentbuilder_changes_queue.csv' INTO TABLE `plugin_cmf_segmentbuilder_changes_queue`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-plugin_cmf_sequence_numbers.csv' INTO TABLE `plugin_cmf_sequence_numbers`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-properties.csv' INTO TABLE `properties`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-quantityvalue_units.csv' INTO TABLE `quantityvalue_units`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-recyclebin.csv' INTO TABLE `recyclebin`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-redirects.csv' INTO TABLE `redirects`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-sanitycheck.csv' INTO TABLE `sanitycheck`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-schedule_tasks.csv' INTO TABLE `schedule_tasks`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-search_backend_data.csv' INTO TABLE `search_backend_data`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-sites.csv' INTO TABLE `sites`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-tags.csv' INTO TABLE `tags`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-tags_assignment.csv' INTO TABLE `tags_assignment`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-targeting_rules.csv' INTO TABLE `targeting_rules`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-targeting_target_groups.csv' INTO TABLE `targeting_target_groups`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-translations_admin.csv' INTO TABLE `translations_admin`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-translations_website.csv' INTO TABLE `translations_website`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-tree_locks.csv' INTO TABLE `tree_locks`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-users.csv' INTO TABLE `users`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-users_permission_definitions.csv' INTO TABLE `users_permission_definitions`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-users_workspaces_asset.csv' INTO TABLE `users_workspaces_asset`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-users_workspaces_document.csv' INTO TABLE `users_workspaces_document`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-users_workspaces_object.csv' INTO TABLE `users_workspaces_object`;
LOAD DATA INFILE '~~DOCUMENTROOT~~/dump/data/dumpexport-uuids.csv' INTO TABLE `uuids`;


DROP VIEW IF EXISTS object_12;
CREATE ALGORITHM=UNDEFINED  VIEW `object_12` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`)));

DROP VIEW IF EXISTS object_14;
CREATE ALGORITHM=UNDEFINED  VIEW `object_14` AS select `object_query_14`.`oo_id` AS `oo_id`,`object_query_14`.`oo_classId` AS `oo_classId`,`object_query_14`.`oo_className` AS `oo_className`,`object_query_14`.`filterdefinition__id` AS `filterdefinition__id`,`object_query_14`.`filterdefinition__type` AS `filterdefinition__type`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_14` join `objects` on((`objects`.`o_id` = `object_query_14`.`oo_id`)));

DROP VIEW IF EXISTS object_15;
CREATE ALGORITHM=UNDEFINED  VIEW `object_15` AS select `object_query_15`.`oo_id` AS `oo_id`,`object_query_15`.`oo_classId` AS `oo_classId`,`object_query_15`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_15` join `objects` on((`objects`.`o_id` = `object_query_15`.`oo_id`)));

DROP VIEW IF EXISTS object_16;
CREATE ALGORITHM=UNDEFINED  VIEW `object_16` AS select `object_query_16`.`oo_id` AS `oo_id`,`object_query_16`.`oo_classId` AS `oo_classId`,`object_query_16`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_16` join `objects` on((`objects`.`o_id` = `object_query_16`.`oo_id`)));

DROP VIEW IF EXISTS object_23;
CREATE ALGORITHM=UNDEFINED  VIEW `object_23` AS select `object_query_23`.`oo_id` AS `oo_id`,`object_query_23`.`oo_classId` AS `oo_classId`,`object_query_23`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_23` join `objects` on((`objects`.`o_id` = `object_query_23`.`oo_id`)));

DROP VIEW IF EXISTS object_30;
CREATE ALGORITHM=UNDEFINED  VIEW `object_30` AS select `object_query_30`.`oo_id` AS `oo_id`,`object_query_30`.`oo_classId` AS `oo_classId`,`object_query_30`.`oo_className` AS `oo_className`,`object_query_30`.`totalPrice` AS `totalPrice`,`object_query_30`.`items` AS `items`,`object_query_30`.`offernumber` AS `offernumber`,`object_query_30`.`dateCreated` AS `dateCreated`,`object_query_30`.`dateValidUntil` AS `dateValidUntil`,`object_query_30`.`discount` AS `discount`,`object_query_30`.`customItems` AS `customItems`,`object_query_30`.`discountType` AS `discountType`,`object_query_30`.`cartId` AS `cartId`,`object_query_30`.`totalPriceBeforeDiscount` AS `totalPriceBeforeDiscount`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_30` join `objects` on((`objects`.`o_id` = `object_query_30`.`oo_id`)));

DROP VIEW IF EXISTS object_31;
CREATE ALGORITHM=UNDEFINED  VIEW `object_31` AS select `object_query_31`.`oo_id` AS `oo_id`,`object_query_31`.`oo_classId` AS `oo_classId`,`object_query_31`.`oo_className` AS `oo_className`,`object_query_31`.`product__id` AS `product__id`,`object_query_31`.`product__type` AS `product__type`,`object_query_31`.`productNumber` AS `productNumber`,`object_query_31`.`productName` AS `productName`,`object_query_31`.`amount` AS `amount`,`object_query_31`.`subItems` AS `subItems`,`object_query_31`.`comment` AS `comment`,`object_query_31`.`originalTotalPrice` AS `originalTotalPrice`,`object_query_31`.`finalTotalPrice` AS `finalTotalPrice`,`object_query_31`.`discount` AS `discount`,`object_query_31`.`DiscountType` AS `DiscountType`,`object_query_31`.`cartItemKey` AS `cartItemKey`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_31` join `objects` on((`objects`.`o_id` = `object_query_31`.`oo_id`)));

DROP VIEW IF EXISTS object_32;
CREATE ALGORITHM=UNDEFINED  VIEW `object_32` AS select `object_query_32`.`oo_id` AS `oo_id`,`object_query_32`.`oo_classId` AS `oo_classId`,`object_query_32`.`oo_className` AS `oo_className`,`object_query_32`.`price` AS `price`,`object_query_32`.`productGroup` AS `productGroup`,`object_query_32`.`OSproductNumber` AS `OSproductNumber`,`object_query_32`.`OSName` AS `OSName`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_32` join `objects` on((`objects`.`o_id` = `object_query_32`.`oo_id`)));

DROP VIEW IF EXISTS object_33;
CREATE ALGORITHM=UNDEFINED  VIEW `object_33` AS select `object_query_33`.`oo_id` AS `oo_id`,`object_query_33`.`oo_classId` AS `oo_classId`,`object_query_33`.`oo_className` AS `oo_className`,`object_query_33`.`name` AS `name`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_33` join `objects` on((`objects`.`o_id` = `object_query_33`.`oo_id`)));

DROP VIEW IF EXISTS object_34;
CREATE ALGORITHM=UNDEFINED  VIEW `object_34` AS select `object_query_34`.`oo_id` AS `oo_id`,`object_query_34`.`oo_classId` AS `oo_classId`,`object_query_34`.`oo_className` AS `oo_className`,`object_query_34`.`token` AS `token`,`object_query_34`.`tokenId` AS `tokenId`,`object_query_34`.`voucherSeries__id` AS `voucherSeries__id`,`object_query_34`.`voucherSeries__type` AS `voucherSeries__type`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_34` join `objects` on((`objects`.`o_id` = `object_query_34`.`oo_id`)));

DROP VIEW IF EXISTS object_35;
CREATE ALGORITHM=UNDEFINED  VIEW `object_35` AS select `object_query_35`.`oo_id` AS `oo_id`,`object_query_35`.`oo_classId` AS `oo_classId`,`object_query_35`.`oo_className` AS `oo_className`,`object_query_35`.`taxEntryCombinationType` AS `taxEntryCombinationType`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_35` join `objects` on((`objects`.`o_id` = `object_query_35`.`oo_id`)));

DROP VIEW IF EXISTS object_36;
CREATE ALGORITHM=UNDEFINED  VIEW `object_36` AS select `object_query_36`.`oo_id` AS `oo_id`,`object_query_36`.`oo_classId` AS `oo_classId`,`object_query_36`.`oo_className` AS `oo_className`,`object_query_36`.`name` AS `name`,`object_query_36`.`reference` AS `reference`,`object_query_36`.`calculated` AS `calculated`,`object_query_36`.`showAsFilter` AS `showAsFilter`,`object_query_36`.`exportNewsletterProvider` AS `exportNewsletterProvider`,`object_query_36`.`filterSortOrder` AS `filterSortOrder`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_36` join `objects` on((`objects`.`o_id` = `object_query_36`.`oo_id`)));

DROP VIEW IF EXISTS object_37;
CREATE ALGORITHM=UNDEFINED  VIEW `object_37` AS select `object_query_37`.`oo_id` AS `oo_id`,`object_query_37`.`oo_classId` AS `oo_classId`,`object_query_37`.`oo_className` AS `oo_className`,`object_query_37`.`name` AS `name`,`object_query_37`.`group__id` AS `group__id`,`object_query_37`.`group__type` AS `group__type`,`object_query_37`.`reference` AS `reference`,`object_query_37`.`calculated` AS `calculated`,`object_query_37`.`useAsTargetGroup` AS `useAsTargetGroup`,`object_query_37`.`targetGroup` AS `targetGroup`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_37` join `objects` on((`objects`.`o_id` = `object_query_37`.`oo_id`)));

DROP VIEW IF EXISTS object_38;
CREATE ALGORITHM=UNDEFINED  VIEW `object_38` AS select `object_query_38`.`oo_id` AS `oo_id`,`object_query_38`.`oo_classId` AS `oo_classId`,`object_query_38`.`oo_className` AS `oo_className`,`object_query_38`.`provider` AS `provider`,`object_query_38`.`identifier` AS `identifier`,`object_query_38`.`profileData` AS `profileData`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_38` join `objects` on((`objects`.`o_id` = `object_query_38`.`oo_id`)));

DROP VIEW IF EXISTS object_39;
CREATE ALGORITHM=UNDEFINED  VIEW `object_39` AS select `object_query_39`.`oo_id` AS `oo_id`,`object_query_39`.`oo_classId` AS `oo_classId`,`object_query_39`.`oo_className` AS `oo_className`,`object_query_39`.`name` AS `name`,`object_query_39`.`terms` AS `terms`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_39` join `objects` on((`objects`.`o_id` = `object_query_39`.`oo_id`)));

DROP VIEW IF EXISTS object_40;
CREATE ALGORITHM=UNDEFINED  VIEW `object_40` AS select `object_query_40`.`oo_id` AS `oo_id`,`object_query_40`.`oo_classId` AS `oo_classId`,`object_query_40`.`oo_className` AS `oo_className`,`object_query_40`.`code` AS `code`,`object_query_40`.`attributeType` AS `attributeType`,`object_query_40`.`label` AS `label`,`object_query_40`.`link` AS `link`,`object_query_40`.`active` AS `active`,`object_query_40`.`utm_source` AS `utm_source`,`object_query_40`.`utm_medium` AS `utm_medium`,`object_query_40`.`utm_campaign` AS `utm_campaign`,`object_query_40`.`utm_term` AS `utm_term`,`object_query_40`.`utm_content` AS `utm_content`,`object_query_40`.`attributes` AS `attributes`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_40` join `objects` on((`objects`.`o_id` = `object_query_40`.`oo_id`)));

DROP VIEW IF EXISTS object_41;
CREATE ALGORITHM=UNDEFINED  VIEW `object_41` AS select `object_query_41`.`oo_id` AS `oo_id`,`object_query_41`.`oo_classId` AS `oo_classId`,`object_query_41`.`oo_className` AS `oo_className`,`object_query_41`.`active` AS `active`,`object_query_41`.`gender` AS `gender`,`object_query_41`.`firstname` AS `firstname`,`object_query_41`.`lastname` AS `lastname`,`object_query_41`.`street` AS `street`,`object_query_41`.`zip` AS `zip`,`object_query_41`.`city` AS `city`,`object_query_41`.`countryCode` AS `countryCode`,`object_query_41`.`email` AS `email`,`object_query_41`.`phone` AS `phone`,`object_query_41`.`manualSegments` AS `manualSegments`,`object_query_41`.`calculatedSegments` AS `calculatedSegments`,`object_query_41`.`idEncoded` AS `idEncoded`,`object_query_41`.`password` AS `password`,`object_query_41`.`ssoIdentities` AS `ssoIdentities`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_41` join `objects` on((`objects`.`o_id` = `object_query_41`.`oo_id`)));

DROP VIEW IF EXISTS object_7;
CREATE ALGORITHM=UNDEFINED  VIEW `object_7` AS select `object_query_7`.`oo_id` AS `oo_id`,`object_query_7`.`oo_classId` AS `oo_classId`,`object_query_7`.`oo_className` AS `oo_className`,`object_query_7`.`pageLimit` AS `pageLimit`,`object_query_7`.`ajaxReload` AS `ajaxReload`,`object_query_7`.`limitOnFirstLoad` AS `limitOnFirstLoad`,`object_query_7`.`defaultOrderByInheritance` AS `defaultOrderByInheritance`,`object_query_7`.`conditionsInheritance` AS `conditionsInheritance`,`object_query_7`.`filtersInheritance` AS `filtersInheritance`,`object_query_7`.`crossSellingCategory__id` AS `crossSellingCategory__id`,`object_query_7`.`crossSellingCategory__type` AS `crossSellingCategory__type`,`object_query_7`.`similarityFieldsInheritance` AS `similarityFieldsInheritance`,`object_query_7`.`infiniteScroll` AS `infiniteScroll`,`object_query_7`.`orderByAsc` AS `orderByAsc`,`object_query_7`.`orderByDesc` AS `orderByDesc`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_7` join `objects` on((`objects`.`o_id` = `object_query_7`.`oo_id`)));

DROP VIEW IF EXISTS object_8;
CREATE ALGORITHM=UNDEFINED  VIEW `object_8` AS select `object_query_8`.`oo_id` AS `oo_id`,`object_query_8`.`oo_classId` AS `oo_classId`,`object_query_8`.`oo_className` AS `oo_className`,`object_query_8`.`product__id` AS `product__id`,`object_query_8`.`product__type` AS `product__type`,`object_query_8`.`productNumber` AS `productNumber`,`object_query_8`.`productName` AS `productName`,`object_query_8`.`amount` AS `amount`,`object_query_8`.`totalPrice` AS `totalPrice`,`object_query_8`.`subItems` AS `subItems`,`object_query_8`.`comment` AS `comment`,`object_query_8`.`orderState` AS `orderState`,`object_query_8`.`totalNetPrice` AS `totalNetPrice`,`object_query_8`.`taxInfo` AS `taxInfo`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_8` join `objects` on((`objects`.`o_id` = `object_query_8`.`oo_id`)));

DROP VIEW IF EXISTS object_9;
CREATE ALGORITHM=UNDEFINED  VIEW `object_9` AS select `object_query_9`.`oo_id` AS `oo_id`,`object_query_9`.`oo_classId` AS `oo_classId`,`object_query_9`.`oo_className` AS `oo_className`,`object_query_9`.`ordernumber` AS `ordernumber`,`object_query_9`.`totalPrice` AS `totalPrice`,`object_query_9`.`orderdate` AS `orderdate`,`object_query_9`.`items` AS `items`,`object_query_9`.`customer__id` AS `customer__id`,`object_query_9`.`customer__type` AS `customer__type`,`object_query_9`.`paymentReference` AS `paymentReference`,`object_query_9`.`orderState` AS `orderState`,`object_query_9`.`cartId` AS `cartId`,`object_query_9`.`customerOrderData` AS `customerOrderData`,`object_query_9`.`currency` AS `currency`,`object_query_9`.`comment` AS `comment`,`object_query_9`.`customerCompany` AS `customerCompany`,`object_query_9`.`customerStreet` AS `customerStreet`,`object_query_9`.`customerZip` AS `customerZip`,`object_query_9`.`customerCountry` AS `customerCountry`,`object_query_9`.`customerEmail` AS `customerEmail`,`object_query_9`.`deliveryCompany` AS `deliveryCompany`,`object_query_9`.`deliveryStreet` AS `deliveryStreet`,`object_query_9`.`deliveryZip` AS `deliveryZip`,`object_query_9`.`deliveryCity` AS `deliveryCity`,`object_query_9`.`deliveryCountry` AS `deliveryCountry`,`object_query_9`.`voucherTokens` AS `voucherTokens`,`object_query_9`.`customerCity` AS `customerCity`,`object_query_9`.`subTotalPrice` AS `subTotalPrice`,`object_query_9`.`customerFirstname` AS `customerFirstname`,`object_query_9`.`customerLastname` AS `customerLastname`,`object_query_9`.`deliveryLastname` AS `deliveryLastname`,`object_query_9`.`deliveryFirstname` AS `deliveryFirstname`,`object_query_9`.`giftItems` AS `giftItems`,`object_query_9`.`subTotalNetPrice` AS `subTotalNetPrice`,`object_query_9`.`totalNetPrice` AS `totalNetPrice`,`object_query_9`.`taxInfo` AS `taxInfo`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy` from (`object_query_9` join `objects` on((`objects`.`o_id` = `object_query_9`.`oo_id`)));

DROP VIEW IF EXISTS object_localized_12_de_AT;
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_12_de_AT` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`de_AT`.`ooo_id` AS `ooo_id`,`de_AT`.`language` AS `language`,`de_AT`.`name` AS `name`,`de_AT`.`seoname` AS `seoname`,`de_AT`.`colorName` AS `colorName`,`de_AT`.`price` AS `price`,`de_AT`.`priceOld` AS `priceOld`,`de_AT`.`fromPrice` AS `fromPrice`,`de_AT`.`description` AS `description`,`de_AT`.`material` AS `material`,`de_AT`.`downloads` AS `downloads`,`de_AT`.`videos` AS `videos`,`de_AT`.`rotation__id` AS `rotation__id`,`de_AT`.`rotation__type` AS `rotation__type`,`de_AT`.`youtubeVideo` AS `youtubeVideo`,`de_AT`.`textsAvailable` AS `textsAvailable` from ((`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`))) left join `object_localized_query_12_de_AT` `de_AT` on((1 and (`object_query_12`.`oo_id` = `de_AT`.`ooo_id`))));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_12_en_GB` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`en_GB`.`ooo_id` AS `ooo_id`,`en_GB`.`language` AS `language`,`en_GB`.`name` AS `name`,`en_GB`.`seoname` AS `seoname`,`en_GB`.`colorName` AS `colorName`,`en_GB`.`price` AS `price`,`en_GB`.`priceOld` AS `priceOld`,`en_GB`.`fromPrice` AS `fromPrice`,`en_GB`.`description` AS `description`,`en_GB`.`material` AS `material`,`en_GB`.`downloads` AS `downloads`,`en_GB`.`videos` AS `videos`,`en_GB`.`rotation__id` AS `rotation__id`,`en_GB`.`rotation__type` AS `rotation__type`,`en_GB`.`youtubeVideo` AS `youtubeVideo`,`en_GB`.`textsAvailable` AS `textsAvailable` from ((`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`))) left join `object_localized_query_12_en_GB` `en_GB` on((1 and (`object_query_12`.`oo_id` = `en_GB`.`ooo_id`))));

DROP VIEW IF EXISTS object_localized_12_fr_FR;
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_12_fr_FR` AS select `object_query_12`.`oo_id` AS `oo_id`,`object_query_12`.`oo_classId` AS `oo_classId`,`object_query_12`.`oo_className` AS `oo_className`,`object_query_12`.`artno` AS `artno`,`object_query_12`.`ean` AS `ean`,`object_query_12`.`size` AS `size`,`object_query_12`.`brand__id` AS `brand__id`,`object_query_12`.`brand__type` AS `brand__type`,`object_query_12`.`gender` AS `gender`,`object_query_12`.`categories` AS `categories`,`object_query_12`.`features` AS `features`,`object_query_12`.`technologies` AS `technologies`,`object_query_12`.`attributes` AS `attributes`,`object_query_12`.`collection` AS `collection`,`object_query_12`.`color` AS `color`,`object_query_12`.`materialComposition` AS `materialComposition`,`object_query_12`.`secondaryMaterialComposition` AS `secondaryMaterialComposition`,`object_query_12`.`relatedProducts` AS `relatedProducts`,`object_query_12`.`imagesInheritance` AS `imagesInheritance`,`object_query_12`.`attributesAvailable` AS `attributesAvailable`,`object_query_12`.`variantsAvailable` AS `variantsAvailable`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`fr_FR`.`ooo_id` AS `ooo_id`,`fr_FR`.`language` AS `language`,`fr_FR`.`name` AS `name`,`fr_FR`.`seoname` AS `seoname`,`fr_FR`.`colorName` AS `colorName`,`fr_FR`.`price` AS `price`,`fr_FR`.`priceOld` AS `priceOld`,`fr_FR`.`fromPrice` AS `fromPrice`,`fr_FR`.`description` AS `description`,`fr_FR`.`material` AS `material`,`fr_FR`.`downloads` AS `downloads`,`fr_FR`.`videos` AS `videos`,`fr_FR`.`rotation__id` AS `rotation__id`,`fr_FR`.`rotation__type` AS `rotation__type`,`fr_FR`.`youtubeVideo` AS `youtubeVideo`,`fr_FR`.`textsAvailable` AS `textsAvailable` from ((`object_query_12` join `objects` on((`objects`.`o_id` = `object_query_12`.`oo_id`))) left join `object_localized_query_12_fr_FR` `fr_FR` on((1 and (`object_query_12`.`oo_id` = `fr_FR`.`ooo_id`))));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_14_en_GB` AS select `object_query_14`.`oo_id` AS `oo_id`,`object_query_14`.`oo_classId` AS `oo_classId`,`object_query_14`.`oo_className` AS `oo_className`,`object_query_14`.`filterdefinition__id` AS `filterdefinition__id`,`object_query_14`.`filterdefinition__type` AS `filterdefinition__type`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`en_GB`.`ooo_id` AS `ooo_id`,`en_GB`.`language` AS `language`,`en_GB`.`image` AS `image`,`en_GB`.`name` AS `name`,`en_GB`.`seoname` AS `seoname`,`en_GB`.`seotext` AS `seotext`,`en_GB`.`sortkey` AS `sortkey` from ((`object_query_14` join `objects` on((`objects`.`o_id` = `object_query_14`.`oo_id`))) left join `object_localized_query_14_en_GB` `en_GB` on((1 and (`object_query_14`.`oo_id` = `en_GB`.`ooo_id`))));

DROP VIEW IF EXISTS object_localized_14_fr_FR;
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_14_fr_FR` AS select `object_query_14`.`oo_id` AS `oo_id`,`object_query_14`.`oo_classId` AS `oo_classId`,`object_query_14`.`oo_className` AS `oo_className`,`object_query_14`.`filterdefinition__id` AS `filterdefinition__id`,`object_query_14`.`filterdefinition__type` AS `filterdefinition__type`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`fr_FR`.`ooo_id` AS `ooo_id`,`fr_FR`.`language` AS `language`,`fr_FR`.`image` AS `image`,`fr_FR`.`name` AS `name`,`fr_FR`.`seoname` AS `seoname`,`fr_FR`.`seotext` AS `seotext`,`fr_FR`.`sortkey` AS `sortkey` from ((`object_query_14` join `objects` on((`objects`.`o_id` = `object_query_14`.`oo_id`))) left join `object_localized_query_14_fr_FR` `fr_FR` on((1 and (`object_query_14`.`oo_id` = `fr_FR`.`ooo_id`))));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_15_en_GB` AS select `object_query_15`.`oo_id` AS `oo_id`,`object_query_15`.`oo_classId` AS `oo_classId`,`object_query_15`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`en_GB`.`ooo_id` AS `ooo_id`,`en_GB`.`language` AS `language`,`en_GB`.`name` AS `name`,`en_GB`.`description` AS `description`,`en_GB`.`icon` AS `icon`,`en_GB`.`usage` AS `usage` from ((`object_query_15` join `objects` on((`objects`.`o_id` = `object_query_15`.`oo_id`))) left join `object_localized_query_15_en_GB` `en_GB` on((1 and (`object_query_15`.`oo_id` = `en_GB`.`ooo_id`))));

DROP VIEW IF EXISTS object_localized_15_fr_FR;
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_15_fr_FR` AS select `object_query_15`.`oo_id` AS `oo_id`,`object_query_15`.`oo_classId` AS `oo_classId`,`object_query_15`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`fr_FR`.`ooo_id` AS `ooo_id`,`fr_FR`.`language` AS `language`,`fr_FR`.`name` AS `name`,`fr_FR`.`description` AS `description`,`fr_FR`.`icon` AS `icon`,`fr_FR`.`usage` AS `usage` from ((`object_query_15` join `objects` on((`objects`.`o_id` = `object_query_15`.`oo_id`))) left join `object_localized_query_15_fr_FR` `fr_FR` on((1 and (`object_query_15`.`oo_id` = `fr_FR`.`ooo_id`))));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_16_en_GB` AS select `object_query_16`.`oo_id` AS `oo_id`,`object_query_16`.`oo_classId` AS `oo_classId`,`object_query_16`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`en_GB`.`ooo_id` AS `ooo_id`,`en_GB`.`language` AS `language`,`en_GB`.`icon` AS `icon`,`en_GB`.`name` AS `name`,`en_GB`.`seoname` AS `seoname`,`en_GB`.`description` AS `description`,`en_GB`.`link` AS `link`,`en_GB`.`images` AS `images`,`en_GB`.`documents` AS `documents`,`en_GB`.`videos` AS `videos`,`en_GB`.`downloads` AS `downloads` from ((`object_query_16` join `objects` on((`objects`.`o_id` = `object_query_16`.`oo_id`))) left join `object_localized_query_16_en_GB` `en_GB` on((1 and (`object_query_16`.`oo_id` = `en_GB`.`ooo_id`))));

DROP VIEW IF EXISTS object_localized_16_fr_FR;
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_16_fr_FR` AS select `object_query_16`.`oo_id` AS `oo_id`,`object_query_16`.`oo_classId` AS `oo_classId`,`object_query_16`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`fr_FR`.`ooo_id` AS `ooo_id`,`fr_FR`.`language` AS `language`,`fr_FR`.`icon` AS `icon`,`fr_FR`.`name` AS `name`,`fr_FR`.`seoname` AS `seoname`,`fr_FR`.`description` AS `description`,`fr_FR`.`link` AS `link`,`fr_FR`.`images` AS `images`,`fr_FR`.`documents` AS `documents`,`fr_FR`.`videos` AS `videos`,`fr_FR`.`downloads` AS `downloads` from ((`object_query_16` join `objects` on((`objects`.`o_id` = `object_query_16`.`oo_id`))) left join `object_localized_query_16_fr_FR` `fr_FR` on((1 and (`object_query_16`.`oo_id` = `fr_FR`.`ooo_id`))));
...
CREATE ALGORITHM=UNDEFINED  VIEW `object_localized_23_fr_FR` AS select `object_query_23`.`oo_id` AS `oo_id`,`object_query_23`.`oo_classId` AS `oo_classId`,`object_query_23`.`oo_className` AS `oo_className`,`objects`.`o_id` AS `o_id`,`objects`.`o_parentId` AS `o_parentId`,`objects`.`o_type` AS `o_type`,`objects`.`o_key` AS `o_key`,`objects`.`o_path` AS `o_path`,`objects`.`o_index` AS `o_index`,`objects`.`o_published` AS `o_published`,`objects`.`o_creationDate` AS `o_creationDate`,`objects`.`o_modificationDate` AS `o_modificationDate`,`objects`.`o_userOwner` AS `o_userOwner`,`objects`.`o_userModification` AS `o_userModification`,`objects`.`o_classId` AS `o_classId`,`objects`.`o_className` AS `o_className`,`objects`.`o_childrenSortBy` AS `o_childrenSortBy`,`fr_FR`.`ooo_id` AS `ooo_id`,`fr_FR`.`language` AS `language`,`fr_FR`.`icon` AS `icon`,`fr_FR`.`name` AS `name`,`fr_FR`.`seoname` AS `seoname`,`fr_FR`.`description` AS `description`,`fr_FR`.`link` AS `link`,`fr_FR`.`images` AS `images`,`fr_FR`.`documents` AS `documents`,`fr_FR`.`videos` AS `videos`,`fr_FR`.`downloads` AS `downloads` from ((`object_query_23` join `objects` on((`objects`.`o_id` = `object_query_23`.`oo_id`))) left join `object_localized_query_23_fr_FR` `fr_FR` on((1 and (`object_query_23`.`oo_id` = `fr_FR`.`ooo_id`))));
