...
class SpecificAttributes extends \Pimcore\Model\Object\Objectbrick {
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\apparel
*/
public function getApparel() { 
	if(!$this->apparel && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\apparel $apparel
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\approvals
*/
public function getApprovals() { 
	if(!$this->approvals && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\approvals $approvals
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsBackpacks
*/
public function getFeaturesBenefitsBackpacks() { 
	if(!$this->featuresBenefitsBackpacks && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsBackpacks $featuresBenefitsBackpacks
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsMats
*/
public function getFeaturesBenefitsMats() { 
	if(!$this->featuresBenefitsMats && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsMats $featuresBenefitsMats
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsShoes
*/
public function getFeaturesBenefitsShoes() { 
	if(!$this->featuresBenefitsShoes && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsShoes $featuresBenefitsShoes
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsSleepingbags
*/
public function getFeaturesBenefitsSleepingbags() { 
	if(!$this->featuresBenefitsSleepingbags && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsSleepingbags $featuresBenefitsSleepingbags
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsTents
*/
public function getFeaturesBenefitsTents() { 
	if(!$this->featuresBenefitsTents && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\featuresBenefitsTents $featuresBenefitsTents
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\featuresHeadlamps
*/
public function getFeaturesHeadlamps() { 
	if(!$this->featuresHeadlamps && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\featuresHeadlamps $featuresHeadlamps
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\matsSpecs
*/
public function getMatsSpecs() { 
	if(!$this->matsSpecs && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\matsSpecs $matsSpecs
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\outdoor
*/
public function getOutdoor() { 
	if(!$this->outdoor && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\outdoor $outdoor
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\rucksackSpecs
*/
public function getRucksackSpecs() { 
	if(!$this->rucksackSpecs && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\rucksackSpecs $rucksackSpecs
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\shoe
*/
public function getShoe() { 
	if(!$this->shoe && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\shoe $shoe
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\shoeDetails
*/
public function getShoeDetails() { 
	if(!$this->shoeDetails && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\shoeDetails $shoeDetails
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\snowsport
*/
public function getSnowsport() { 
	if(!$this->snowsport && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\snowsport $snowsport
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\specsSleepingbags
*/
public function getSpecsSleepingbags() { 
	if(!$this->specsSleepingbags && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\specsSleepingbags $specsSleepingbags
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\tentGroundsheet
*/
public function getTentGroundsheet() { 
	if(!$this->tentGroundsheet && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\tentGroundsheet $tentGroundsheet
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\tentSpecifications
*/
public function getTentSpecifications() { 
	if(!$this->tentSpecifications && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\tentSpecifications $tentSpecifications
* @return void
*/
...
/**
* @return \Pimcore\Model\Object\Objectbrick\Data\weight
*/
public function getWeight() { 
	if(!$this->weight && \Pimcore\Model\Object\AbstractObject::doGetInheritedValues($this->getObject())) { 
		$brick = $this->getObject()->getValueFromParent("specificAttributes");
		if(!empty($brick)) {
...
/**
* @param \Pimcore\Model\Object\Objectbrick\Data\weight $weight
* @return void
*/
