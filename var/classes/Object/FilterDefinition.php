...
/**
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByPageLimit ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByDefaultOrderByInheritance ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByDefaultOrderBy ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByOrderByAsc ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByOrderByDesc ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByAjaxReload ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByInfiniteScroll ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByLimitOnFirstLoad ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByConditionsInheritance ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByConditions ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByFiltersInheritance ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByFilters ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getByCrossSellingCategory ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getBySimilarityFieldsInheritance ($value, $limit = 0) 
* @method \Pimcore\Model\Object\FilterDefinition\Listing getBySimilarityFields ($value, $limit = 0) 
*/
...
* @param \Pimcore\Model\Object\ProductCategory $crossSellingCategory
* @return \Pimcore\Model\Object\FilterDefinition
*/
