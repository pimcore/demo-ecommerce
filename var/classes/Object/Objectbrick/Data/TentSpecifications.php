...
/** Generated at 2016-04-14T10:56:13+02:00 */
...
class TentSpecifications extends Object\Objectbrick\Data\AbstractData  {
...
public function getOutsideMaterial () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("outsideMaterial")->isEmpty($data)) {
...
* @return \Pimcore\Model\Object\TentSpecifications
*/
...
public function getInsideMaterial () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("insideMaterial")->isEmpty($data)) {
...
public function getFloorMaterial () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("floorMaterial")->isEmpty($data)) {
...
public function getWaterproofRain () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("waterproofRain")->isEmpty($data)) {
...
public function getWaterproofGround () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("waterproofGround")->isEmpty($data)) {
...
public function getConstruction () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("construction")->isEmpty($data)) {
...
public function getTentPegs () {
	$data = $this->tentPegs;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("tentPegs")->isEmpty($data)) {
...
public function getIsMainSeamTaped () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("isMainSeamTaped")->isEmpty($data)) {
