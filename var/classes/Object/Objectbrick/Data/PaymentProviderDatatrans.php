...
/** Generated at 2016-04-07T17:12:02+02:00 */
...
class PaymentProviderDatatrans extends Object\Objectbrick\Data\AbstractData  {
...
public function getAuth_aliasCC () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_aliasCC")->isEmpty($data)) {
...
* @return \Pimcore\Model\Object\PaymentProviderDatatrans
*/
...
public function getAuth_expm () {
	$data = $this->auth_expm;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_expm")->isEmpty($data)) {
...
public function getAuth_expy () {
	$data = $this->auth_expy;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_expy")->isEmpty($data)) {
...
public function getAuth_reqtype () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_reqtype")->isEmpty($data)) {
...
public function getAuth_uppTransactionId () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_uppTransactionId")->isEmpty($data)) {
...
public function getAuth_refno () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("auth_refno")->isEmpty($data)) {
