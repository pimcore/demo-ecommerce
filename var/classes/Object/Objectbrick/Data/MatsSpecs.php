...
class MatsSpecs extends Object\Objectbrick\Data\AbstractData  {
...
public function getHeight () {
	$data = $this->height;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("height")->isEmpty($data)) {
...
public function getMaterialTop () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("materialTop")->isEmpty($data)) {
...
public function getMaterialBottom () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("materialBottom")->isEmpty($data)) {
...
public function getIsCFCfree () {
	$data = $this->isCFCfree;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("isCFCfree")->isEmpty($data)) {
...
public function getHas3partWaveShape () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("has3partWaveShape")->isEmpty($data)) {
...
public function getStructure () {
	$data = $this->structure;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("structure")->isEmpty($data)) {
