...
/** Generated at 2016-04-14T10:55:01+02:00 */
...
class FeaturesHeadlamps extends Object\Objectbrick\Data\AbstractData  {
...
public function getLumen () {
	$data = $this->lumen;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("lumen")->isEmpty($data)) {
...
* Set lumen - <img style="height:40px; float:left; margin:-10px 10px 0 0" src="/static/backend/img/bricks/headlamps/lumen.png"/> Lumen
* @param float $lumen
* @return \Pimcore\Model\Object\FeaturesHeadlamps
*/
...
public function getLightDistance () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("lightDistance")->isEmpty($data)) {
...
public function getLightDuration () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("lightDuration")->isEmpty($data)) {
...
public function getLedType () {
	$data = $this->ledType;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("ledType")->isEmpty($data)) {
...
public function getLedBoost () {
	$data = $this->ledBoost;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("ledBoost")->isEmpty($data)) {
...
public function getLedRed () {
	$data = $this->ledRed;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("ledRed")->isEmpty($data)) {
...
public function getWaterResistant () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("waterResistant")->isEmpty($data)) {
...
public function getBatteries () {
	$data = $this->batteries;
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("batteries")->isEmpty($data)) {
...
public function getHasFlashingMode () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("hasFlashingMode")->isEmpty($data)) {
...
public function getIsCeApproved () {
	...
	if(\Pimcore\Model\Object::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("isCeApproved")->isEmpty($data)) {
